     ...
     if(array.length > 5){
      ...
      return (
        <tr key={i}>
          ...
          <td>
          <button className="btn btn-primary mx-3 fa-solid fa fa-edit" onClick={()=>this.edit(el)}></button>
          <button className="btn btn-danger mx-3 fa fa-trash" onClick={()=>{this.deleteById(el)}}></button>
          </td>
        </tr>
      ) 
